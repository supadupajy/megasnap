...
• 전산실, 자료 보관실 등의 접근 통제`,
  ...
  {
    title: '제10조 (위치 정보 처리)',
    content: `회사는 위치 기반 서비스 제공을 위해 이용자의 위치 정보를 수집·이용합니다.

• 수집 목적: 지도 기반 게시물 탐색, 게시물 위치 태그, 주변 콘텐츠 추천
• 수집 방법: 이용자의 명시적 동의 후 기기 GPS를 통해 수집
• 보유 기간: 서비스 이용 기간 (게시물에 태그된 위치는 게시물 삭제 시까지)
• 제3자 제공: 카카오 지도 API (지도 표시 목적)

이용자는 기기 설정에서 언제든지 위치 정보 수집을 거부할 수 있으며, 이 경우 위치 기반 서비스 이용이 제한될 수 있습니다.`,
  },
  {
