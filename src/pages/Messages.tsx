            ...
            <div className="space-y-1">
              {filteredConversations.map((conv) => {
                ...
                return (
                  ...
                  >
                    <div 
                      className="w-14 h-14 rounded-full p-[2.5px] bg-gradient-to-tr from-yellow-400 to-indigo-600 shrink-0 shadow-sm"
                      onClick={(e) => {
                        e.stopPropagation();
                        navigate(`/profile/${conv.other_id}`);
                      }}
                    >
                      <img 
                        src={conv.profile.avatar_url || `https://i.pravatar.cc/150?u=${conv.other_id}`} 
                        alt="avatar" 
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between mb-0.5">
                        <p className={`text-sm ${conv.unread_count > 0 ? 'font-black text-gray-900' : 'font-bold text-gray-700'}`}>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {conv.unread_count > 0 && (
                          <div className="bg-indigo-600 text-white text-[8px] font-black px-1.5 py-0.5 rounded-full">
                            {conv.unread_count}
                          </div>
                        )}
                      </div>
