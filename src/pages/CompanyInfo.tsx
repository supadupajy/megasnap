...
const info = [
  ...
  { icon: Mail, label: '이메일', value: 'support@thesnappop.com' },
  { icon: Phone, label: '고객센터', value: '02-1234-5678' },
  { icon: Globe, label: '웹사이트', value: 'www.thesnappop.com' },
];
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar" style={{ paddingBottom: 'calc(4.5rem + env(safe-area-inset-bottom, 0px))' }}>
        <div className="px-4 pt-5">
          ...
          <div className="flex flex-col items-center py-6 mb-4">
            ...
            <h2 className="text-lg font-black"><span className="text-gray-900">하이</span><span className="text-amber-500">버블</span></h2>
          ...
          <p className="text-center text-[11px] text-gray-300 font-medium mt-6 leading-relaxed">
            하이버블은 통신판매중개자로서 거래 당사자가 아니며,<br />
