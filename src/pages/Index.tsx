          ...
          {!isSelectingLocation && !isSelectingAdLocation && (
            <>
              ...
              >
                ...
                <button onClick={() => { shutterRef.current?.trigger(() => setIsSearchOpen(true)); }} className="w-12 h-12 bg-white/30 backdrop-blur-xl text-gray-700 rounded-2xl flex items-center justify-center shadow-lg active:scale-90 transition-all border border-white/50"><Search className="w-6 h-6" /></button>
                ...
                >
                  <div className="flex flex-col items-center gap-2 bg-white/30 backdrop-blur-xl border border-white/50 shadow-lg rounded-2xl px-2.5 py-3">
                    ...
                    <div style={{
                      ...
                      height: '100px',
                      borderRadius: '4px',
                      background: 'linear-gradient(to bottom, #5a00a0, #a0001e, #ff3c00, #ffa000, #ffdc00, #78dc28, #3cdca0, #64d2ff)',
                    }} />
