    ...
    <>
      ...
      <AnimatePresence>
        {isTrendingExpanded && !isPostListOpen && !isSearchOpen && (
          ...
          >
            <div className="absolute left-0 right-0 flex flex-col items-center gap-2 pointer-events-none select-none" style={{ bottom: 'calc(env(safe-area-inset-bottom, 0px) + 8rem)' }}>              
