...
import { Grid, Bookmark, Map as MapIcon, ChevronLeft, UserPlus, MessageCircle, User as UserIcon, MoreHorizontal } from 'lucide-react';
        ...
        <div className="px-4 py-6 bg-gray-50/50 border-b border-gray-100">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-black text-gray-900">@{userId || 'traveler'}</h2>
                <p className="text-xs text-gray-400 font-medium">탐험가의 프로필을 확인하세요</p>
              </div>
            </div>
