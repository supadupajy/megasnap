...
const faqs = [
  ...
  },
  {
    ...
    items: [
      {
        q: '포스팅은 어떻게 삭제하나요?',
        a: '포스팅 상세 화면에서 우측 상단 메뉴(···)를 눌러 삭제할 수 있습니다. 삭제된 포스팅은 복구되지 않습니다.',
      },
      {
        q: '포스팅이 지도에 표시되지 않아요.',
  ...
  },
  {
    ...
    items: [
      {
        q: '구독을 취소하면 바로 해지되나요?',
        a: '구독 취소 시 현재 결제 기간이 끝날 때까지 Pro 기능을 계속 이용할 수 있습니다. 기간 종료 후 자동으로 Free 플랜으로 전환됩니다.',
      },
      {
        q: '환불은 어떻게 받나요?',
        a: '결제일로부터 7일 이내에 1:1 문의를 통해 환불 요청이 가능합니다. 이미 사용한 기능이 있는 경우 부분 환불될 수 있습니다.',
      },
    ],
  },
];
