...
const AD_TYPES = [
  ...
  { id: 'feed', icon: MessageSquare, label: '피드 광고', desc: '컨텐츠 사이에 광고를 보여줍니다', disabled: false },
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar" style={{ paddingBottom: 'calc(4.5rem + env(safe-area-inset-bottom, 0px))' }}>
        ...
        <div className="mx-4 mt-5 bg-gradient-to-br from-yellow-300 via-amber-400 to-orange-400 rounded-3xl p-6 text-gray-900 shadow-xl shadow-amber-200">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <p className="text-xs font-bold text-gray-900/70 uppercase tracking-widest">하이버블즈 Ads</p>
          ...
          <p className="text-sm text-gray-900/80 font-medium leading-relaxed">
            실시간 위치 기반 플랫폼 하이버블즈에서 타겟 고객에게 정확하게 도달하세요.
          </p>
        ...
        <form onSubmit={handleSubmit} className="px-4 pt-6 space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-black text-amber-600">support@hibubblez.com</p>
            </div>
          </div>
