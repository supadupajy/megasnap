      ...
      <DrawerContent className="h-[85vh]">
        ...
        <div className="px-6 flex flex-col h-full">
          ...
          <div className="flex-1 space-y-6 overflow-y-auto pb-20">
            ...
            <div className="flex items-center gap-3 p-4 bg-green-50 rounded-2xl border border-green-100">
              ...
              <div className="flex-1">
                <p className="text-xs text-green-600 font-bold">현재 위치</p>
                <p className="text-sm font-medium text-gray-800">서울특별시 중구 세종대로 110</p>
              </div>
              <Button variant="ghost" size="sm" className="text-green-600 font-bold">변경</Button>
            </div>

            {/* Content Input */}
            <Textarea 
              placeholder="이 장소에서의 추억을 기록해보세요..."
              className="min-h-[150px] border-none bg-gray-50 rounded-2xl p-4 focus-visible:ring-green-500 resize-none text-base"
              value={content}
          ...
          <div className="absolute bottom-8 left-0 right-0 px-6">
            <Button 
              className="w-full h-14 bg-green-500 hover:bg-green-600 text-white rounded-2xl text-lg font-bold shadow-lg shadow-green-100"
              onClick={handlePost}
              disabled={!content}
            >
              게시하기
