...
const MapContainer = ({
  ...
  const getMarkerInnerHtml = (post: any, isViewed: boolean) => {
    ...
    const innerBoxBackground = hasVideo && !optimizedDisplayImage && !videoThumbCacheRef.current.get(post.id)
      ? 'background:radial-gradient(circle at 24% 18%,rgba(255,255,255,0.26) 0 12%,transparent 34%),radial-gradient(circle at 82% 80%,rgba(196,181,253,0.12) 0 12%,transparent 34%),linear-gradient(150deg,#111827 0%,#1f2937 58%,#334155 100%);'
      : 'background:radial-gradient(circle at 24% 18%,rgba(255,255,255,0.30) 0 11%,transparent 33%),radial-gradient(circle at 82% 80%,rgba(191,219,254,0.16) 0 12%,transparent 34%),linear-gradient(155deg,rgba(255,255,255,0.28) 0%,rgba(255,255,255,0.08) 32%,rgba(148,163,184,0.16) 100%);';
    const innerBoxStyle = `width:60px;height:60px;border-radius:50%;position:relative;z-index:2;${inlineBorderStyle}box-shadow:0 8px 18px rgba(15,23,42,0.14),0 0 0 1px rgba(255,255,255,0.18),inset 0 2px 8px rgba(255,255,255,0.34),inset 0 -10px 18px rgba(15,23,42,0.12);${innerBoxBackground}box-sizing:border-box;overflow:hidden;`;
    const bubbleReflectionHtml = `<div class="marker-bubble-reflection" style="position:absolute;inset:0;border-radius:50%;pointer-events:none;z-index:4;overflow:hidden;background:radial-gradient(circle at 26% 18%,rgba(255,255,255,0.34) 0 14%,transparent 34%),linear-gradient(155deg,rgba(255,255,255,0.26) 0%,rgba(255,255,255,0.12) 20%,rgba(255,255,255,0.04) 34%,transparent 48%,rgba(59,130,246,0.06) 74%,rgba(15,23,42,0.10) 100%);box-shadow:inset 0 0 0 1px rgba(255,255,255,0.24),inset 0 2px 8px rgba(255,255,255,0.24),inset 0 -10px 16px rgba(15,23,42,0.10);">
      <div style="position:absolute;top:5px;left:6px;width:31px;height:18px;border-radius:999px;transform:rotate(-18deg);background:radial-gradient(ellipse at 34% 36%,rgba(255,255,255,0.96) 0 26%,rgba(255,255,255,0.58) 46%,rgba(255,255,255,0.20) 66%,transparent 82%);"></div>
      <div style="position:absolute;top:12px;left:11px;width:18px;height:12px;border-radius:999px;transform:rotate(-18deg);background:radial-gradient(ellipse at 50% 50%,rgba(255,255,255,0.64) 0 34%,rgba(255,255,255,0.12) 68%,transparent 84%);"></div>
      <div style="position:absolute;top:20px;left:18px;width:9px;height:9px;border-radius:50%;background:radial-gradient(circle,rgba(255,255,255,0.88) 0 28%,rgba(255,255,255,0.18) 62%,transparent 82%);"></div>
      <div style="position:absolute;right:8px;bottom:9px;width:28px;height:14px;border-radius:999px;transform:rotate(-20deg);background:radial-gradient(ellipse at 50% 50%,rgba(255,255,255,0.14) 0 28%,rgba(255,255,255,0.05) 56%,transparent 76%);"></div>
      <div style="position:absolute;inset:4px;border-radius:50%;border:1px solid rgba(255,255,255,0.22);"></div>
      <div style="position:absolute;inset:0;border-radius:50%;background:radial-gradient(circle at 50% 115%,rgba(15,23,42,0.12) 0 32%,transparent 58%),conic-gradient(from 210deg,rgba(255,255,255,0.12),transparent 26%,transparent 70%,rgba(255,255,255,0.10) 86%,rgba(255,255,255,0.12));mix-blend-mode:screen;"></div>
    </div>`;
