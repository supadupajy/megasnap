...
export const HiBubbleIcon = ({ className }: BrandProps) => (
  ...
  >
    <defs>
      ...
      <filter id="hi-bubble-shadow" x="18" y="16" width="86" height="96" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
        <feDropShadow dx="0" dy="8" stdDeviation="5" floodColor="#111827" floodOpacity="0.16" />
      </filter>
    </defs>
    ...
    <path d="M28 84C40 74 51 73 64 80C75 86 86 85 95 77" stroke="#9A5A00" strokeOpacity="0.2" strokeWidth="6" strokeLinecap="round" />

    <g filter="url(#hi-bubble-shadow)">
      <path
      ...
      />
      <circle cx="60" cy="51" r="16" fill="#111827" />
      <path d="M48 50C55 43 66 43 73 50" stroke="#FFFFFF" strokeOpacity="0.84" strokeWidth="3" strokeLinecap="round" />
      <path d="M47 57C54 63 65 64 73 57" stroke="#FFFFFF" strokeOpacity="0.72" strokeWidth="3" strokeLinecap="round" />
      <path d="M60 36V66" stroke="#FFFFFF" strokeOpacity="0.38" strokeWidth="2.4" strokeLinecap="round" />
      <path d="M42 51H78" stroke="#FFFFFF" strokeOpacity="0.34" strokeWidth="2.4" strokeLinecap="round" />
    </g>
...
export const HiBubbleBrand = ({ className }: BrandProps) => (
  <div className={cn('inline-flex items-center gap-2.5', className)}>
    <HiBubbleIcon className="h-9 w-9 drop-shadow-sm" />
