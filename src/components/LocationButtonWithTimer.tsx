...
// 인디고 톤 버튼과 어울리도록 살짝 연한 초록 사용
const RING_PROGRESS_COLOR = '#4ade80';            // 연한 초록 (Tailwind green-400) — 남은 시간
const RING_TRACK_COLOR = 'rgba(74,222,128,0.18)'; // 더 옅은 초록 — 지난 시간 트랙
const RING_GLOW = '0 0 3px rgba(74,222,128,0.45)'; // 부드러운 발광 (살짝 약하게)
