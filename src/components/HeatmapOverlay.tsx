    ...
    if (data.length > 0) {
      heat
        ...
        .gradient({
          ...
          0.04: 'rgba(125,211,252,0.52)',
          0.08: 'rgba(56,189,248,0.68)',
          0.11: 'rgba(34,211,238,0.74)',
          0.13: 'rgba(132,204,22,0.72)',
          0.145: 'rgba(255,235,59,0.74)',
          0.52: 'rgba(255,220,0,0.72)',
          0.78: 'rgba(255,170,0,0.74)',
          0.96: 'rgba(255,105,0,0.74)',
