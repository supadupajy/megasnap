    ...
    if (data.length > 0) {
      heat
        ...
        .gradient({
          ...
          0.04: 'rgba(125,211,252,0.68)',
          0.08: 'rgba(56,189,248,0.82)',
          0.11: 'rgba(34,211,238,0.88)',
          0.13: 'rgba(132,204,22,0.84)',
          0.145: 'rgba(255,235,59,0.86)',
          0.52: 'rgba(255,220,0,0.84)',
          0.78: 'rgba(255,170,0,0.84)',
          0.96: 'rgba(255,105,0,0.84)',
          1.00: 'rgba(220,40,0,0.86)',
        })
        .draw(0.18);
    }
