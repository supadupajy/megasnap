...
const ProfileEditDrawer = ({ isOpen, onClose, onUpdate }: ProfileEditDrawerProps) => {
  ...
  return (
    <Drawer open={isOpen} onOpenChange={(open) => !open && onClose()}>
      ...
      <DrawerContent className="h-[80vh] flex flex-col outline-none bg-white rounded-t-[40px] overflow-hidden z-[140]">
        {/* Handle Bar */}
        ...
        <div className="flex flex-col flex-1 min-h-0">
          ...
          <div className="px-8 pt-6 pb-12 bg-white shrink-0 border-t border-gray-50">
            <Button 
