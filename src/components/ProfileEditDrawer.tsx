...
const ProfileEditDrawer = ({ isOpen, onClose, onUpdate }: ProfileEditDrawerProps) => {
  ...
  return (
    <Drawer open={isOpen} onOpenChange={(open) => !open && onClose()}>
      ...
      */}
      <DrawerContent className="h-[80vh] flex flex-col outline-none bg-white rounded-t-[40px] overflow-hidden z-[1500] mb-[100px] border-none shadow-[0_-10px_40px_rgba(0,0,0,0.1)]">
        {/* Handle Bar */}
        ...
        <div className="flex flex-col flex-1 min-h-0">
          ...
          <div className="px-8 pt-4 pb-10 bg-white shrink-0 border-t border-gray-50">
            <Button 
