...
const ProfileEditDrawer = ({ isOpen, onClose, onUpdate }: ProfileEditDrawerProps) => {
  ...
  return (
    <Drawer open={isOpen} onOpenChange={(open) => !open && onClose()}>
      ...
      */}
      <DrawerContent className="h-[80vh] flex flex-col outline-none bg-white rounded-t-[40px] overflow-hidden z-[1500] mb-[10px] border-none shadow-[0_-10px_40px_rgba(0,0,0,0.1)]">
        {/* Handle Bar */}
